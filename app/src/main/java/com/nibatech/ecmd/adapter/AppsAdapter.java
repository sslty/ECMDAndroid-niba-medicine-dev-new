...
public class AppsAdapter extends BaseAdapter {
    ...
    public AppsAdapter(Context context, ArrayList<AppBean> data,int id) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        intent.putExtra(PhotoViewActivity.IMAGE_NUM, 6);//选择数量
                    } else if (position == 1) {
                    ...
                    intent.putExtra(PhotoViewActivity.VIEW_ID, id);
                    //告诉调用的activity，返回的数据
