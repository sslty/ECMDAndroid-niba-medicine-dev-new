...
import com.nibatech.ecmd.view.CustomDepartmentView;
 ...
 * 医生端／患者端／游客端   news
 */
public class TestDepartmentFragment extends Fragment{

    private ArrayList<Department> departmentList = new ArrayList<>();
    private CustomDepartmentView departmentView;
...
//          {"正在定位..."},
            // 热门城市
            {"热门城市", "上海", "石家庄", "昆明", "杭州", "广州", "成都", "西安", "南京", "深圳",
...
//        final View view1 = inflater.inflate(R.layout.fragment_test, container, false);
//        departmentView = (CustomDepartmentView) view1.findViewById(R.id.departView);
//        for (int i = 0; i < cityArray.length; i++) {
//            Department department = new Department();
//            List<String> stringList = new ArrayList<>();
//            for (int j = 0; j < cityArray[i].length; j++) {
//                stringList.add(cityArray[i][j]);
//            }
//            department.setDepartment(cityArray[i][0]);
//            department.setSubDepartment(stringList);
...
//            }
//        };
//        view.setVisibility(BaseView.Visibility.SUCCESS);
//
        return null;
    }
