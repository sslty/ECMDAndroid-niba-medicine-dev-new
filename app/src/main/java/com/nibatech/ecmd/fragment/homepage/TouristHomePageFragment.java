...
import com.nibatech.ecmd.activity.guide.TouristGuideActivity;
 ...
 * 游客端   首页
 */
public class TouristHomePageFragment extends HomePageFragment implements HomePageFragment.ShowHomePageDataListener {
    @Override
    ...
    public void onClickGuide() {
        startActivityBindData(TouristGuideActivity.class, getAPIsUrl(getActivity()).getEntranceOltTourist());
    }
